...
[rms_tot_vel, rms_lane_vel, rms_skid_vel, rms_still_vel] = RMS(v_n_nb, ins_data(4:6,:))
[rms_tot_bacc, rms_lane_bacc, rms_skid_bacc, rms_still_bacc] = RMS(bacc_b_nb, ins_data(7:9,:))
[rms_tot_att, rms_lane_att, rms_skid_att, rms_still_att] = RMS(ssa(att_n_nb, 'rad'), ssa(ins_data(10:12,:), 'rad'));
rms_tot_att = rad2deg * rms_tot_att 
rms_lane_att = rad2deg * rms_lane_att 
rms_skid_att = rad2deg * rms_skid_att 
rms_still_att = rad2deg * rms_still_att
[rms_tot_bars, rms_lane_bars, rms_skid_bars, rms_still_bars] = RMS(ssa(bars_b_nb, 'rad'), ssa(ins_data(13:15,:),'rad'));
rms_tot_bars = rad2deg * rms_tot_bars 
rms_lane_bars = rad2deg * rms_lane_bars 
rms_skid_bars = rad2deg * rms_skid_bars
rms_still_bars = rad2deg * rms_still_bars
